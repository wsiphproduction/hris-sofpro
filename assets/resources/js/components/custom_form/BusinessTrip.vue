<script>
    module.exports = {
        ...
        methods: {
            ...
            export_link(){
                let URL = base_url +'custom/businesstrip/export';
        		...
        		if(obj && obj.employments){
        			...
        			if(employment){
        				...
        				if(organization == 'division'){
							...
							this.form.approver_id = approver.supervisor_id;
							this.form.approver_name = approver.supervisor.first_name+' '+approver.supervisor.last_name;
            ...
            initForm(){
                ...
                let url = base_url + 'custom/businesstrip/init';
            ...
            fetchRecord(){
                ...
                let REST = base_url + 'custom/businesstrip/fetch';
